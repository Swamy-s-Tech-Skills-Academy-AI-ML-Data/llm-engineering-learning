...
## Setup instructions for Windows 11 with Python 3.12

**This is a comprehensive setup guide for the LLM Engineering Learning repository on Windows 11. This workspace follows structured best practices for prompt engineering, RAG, agents, and evaluation workflows.**
...
## Step 0 - Before we begin - addressing the "GOTCHAS" for Windows 11

Ignore this section at your peril! 80% of the questions I get about setup are solved by these very common Windows system issues.

1. **Permissions**: Please take a look at this [tutorial](https://chatgpt.com/share/67b0ae58-d1a8-8012-82ca-74762b0408b0) on permissions on Windows. If you ever have an error that you don't have the rights / permissions / ability to run a script or install software, then read this first. ChatGPT can tell you everything you need to know about Permissions on Windows.
...
1. **Install Git** (if not already installed):
   ...
   - Open a new PowerShell Prompt (Start menu >> PowerShell). If you ever have permissions errors, try opening PowerShell by right-clicking and selecting "Run as Administrator"
...
1. **Create projects directory as needed**
...
1. **Install Cursor and open the project:**
...
### Option B: Using Python 3.12 Virtual Environment (Traditional Method)

If you prefer the traditional approach or if uv doesn't work for your setup:

1. **Ensure Python 3.12 is installed on Windows 11**

   Check your Python version:

   ```powershell
   py -0  # Shows all installed Python versions on Windows
   python --version  # Shows default Python version
   ```
